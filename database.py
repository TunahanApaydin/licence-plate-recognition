...
class DB(object):
    ...
    def _create_table(self, sql_statements: list):
        try:
    ...
    def _insert_data(self, sql_statement: str, data: tuple):
        try:
            cursor = self.connection.cursor()
...
if __name__ == "__main__":
    ...
    #db._create_table(create_table_statements)
    
    # data = ("Name2", "Surname2", "41AHA861")
    # statement = "INSERT INTO {}{} VALUES(?,?,?)".format("users", "(first_name, last_name, licence_plate)")
    # db._insert_data(sql_statement=statement, data=data)
